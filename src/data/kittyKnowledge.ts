...
const KNOWLEDGE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    answers: [
      'Buchung löschen:\n\n1. Buchung öffnen\n2. Auf das **Löschen-Symbol** (🗑️) klicken\n3. Bestätigen\n\n⚠️ Gelöschte Buchungen können nicht wiederhergestellt werden. Bei abgeschlossenen Perioden lieber mit einer **Korrekturbuchung** arbeiten.',
    ],
    tags: ['buchung'],
  },
  {
